...
namespace SAPO.utilities
{
    public class ZkemClient : IZKEM
    {
        ...
        public bool Connect_Net(string IPAdd, int Port)
        {
            ...
            {
                //65535, 32767
                if (objCZKEM.RegEvent(254, 32767))
                {
        ...
        { 
            ...
            RaiseDeviceEvent?.Invoke(this, "FingerDetected");
        }
        ...
        public bool SSR_GetGeneralLogDataWithMask(int dwMachineNumber, out string dwEnrollNumber, out int dwVerifyMode,
            out int dwInOutMode, out int dwYear, out int dwMonth, out int dwDay, out int dwHour, out int dwMinute,
            out int dwSecond, ref int dwWorkCode, out int dwMask, out string dwTemperature)
        {
            throw new NotImplementedException();
        }

        public bool SSR_GetGeneralLogDataWithMaskEx(int dwMachineNumber, out string dwEnrollNumber, out int dwVerifyMode,
            out int dwInOutMode, out int dwYear, out int dwMonth, out int dwDay, out int dwHour, out int dwMinute,
            out int dwSecond, ref int dwWorkCode, out int dwMask, out string dwTemperature, out int dwhelmelhat)
        {
            throw new NotImplementedException();
        }
